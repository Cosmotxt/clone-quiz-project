...
export default function QuizPage() {
  ...
  return (
      <div className="w-full min-h-screen flex flex-col gap-7 items-center justify-center bg-black p-4">
        <h1 className="text-4xl text-gray-300 font-bold">Caixa Preta Quiz</h1>
        <div className="w-full max-w-md border-2 border-red-700  bg-gray-300 shadow-lg rounded-xl p-6">
            {!finished ? (
                <>
          ...
          <div className="text-center text-zinc-900">
            ...
            <p className=" flex flex-col gap-4">
                ...
                <span>As respostas estão aparecendo apenas para fins de demonstração</span>
            </p>
          </div>
        )}
      </div>
